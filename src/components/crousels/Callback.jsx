...
const Callback = () => {
  return (
    <div className='calback pl-28 flex pb-7'>
      ...
      <div >
      <h1 className='text-white font-semibold text-center text-5xl pt-8 pb-20'>Why Edzorb Law?</h1>
        <div>
          <div className='text-lg text-white'>
            ...
            <p className='mb-4 ml-8'>Give learners access to the highest quality digital learning <br/> materials and resources.</p>
            <p className='pb-4 ml-8'>Edzorb Law’s Guidance + Your Dedication = A rank in Top 10!</p>
          </div>

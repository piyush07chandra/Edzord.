...
<div className='second-div'>
  <h1 className='text-3xl font-semibold'>Best Doubt Support & Peer Guidance</h1>
  <ul className='text-lg'>
    <li className='mt-3'>.    Personalized One to One Mentorship Session</li>
    <li className='mt-3'>.    Soulspeak Podcast to Help You Relief Stress & Anxiety</li>
    <li className='mt-3'>.    Right Content, Right Mindset & Right Guidance</li>
    <li className='mt-3'>.    Free Consultation Related to Judiciary Preparation</li>
    <li className='mt-3'>.    Edzorb Study Space to Increase Productivity</li>
  </ul>

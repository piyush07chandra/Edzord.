...
<div className='second-div'>
  <h1 className='text-3xl font-semibold'>General Knowledge & Current Affairs</h1>
  <ul className='text-lg'>
  <li className='mt-3'>.    Holistic Coverage – History, Polity, Geography, Economics,</li>
    <li className='ml-3'> Environment, Static GK & GS topics</li>
    <li className='mt-3'>.    Lucid, Visual Flashcards, Flow Charts</li>
    <li className='mt-3'>.    Complete Coverage of NCERT in Question Answer Format</li>
    <li className='mt-3'>.    Retainable & Fun to Learn</li>
  </ul>

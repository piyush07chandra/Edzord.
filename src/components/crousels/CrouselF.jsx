...
const CrouselF = () => {
  ...
  <h1 className='text-3xl font-semibold'>Flashcards – Case Laws, Legal Maxims, Legal Updates & One Liners</h1>
  <ul className='text-lg'>
    <li className='mt-3'>.    Up to date Legal Updates with Summaries and Citations</li>
    <li className='mt-3'>.    Frequently Asked Case Laws from Past Year Question Papers</li>
    <li className='mt-3'>.    Well Structured Flashcards in Visual Learning Format</li>  
    <li className='mt-3'>.    Easy to Revise & Keep You Exam Ready</li>
  </ul>

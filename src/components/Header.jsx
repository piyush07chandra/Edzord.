  ...
  return (
    ...
    <div className="navbar-brand">
      ...
      <a href="/" className="navbar-logo">
        <img className="h-14 w-38 ml-16 " src="/images/headerImages/legal-rumble-2-logo.png"/>
      </a>
    </div>
    ...
    <div className="flex">
      ...
      <div className="flex">
        <img className="h-8 w-8 mt-2 ml-2" src="/images/headerImages/Asset-144.png"/>
        <a className="text-xl font-normal -ml-2">Podcast</a>
      </div>

      <div className="login-signup flex ml-48 mr-28">
        <img className=" h-12 w-12 mr-6 p-2 hover:bg-gray-600 hover:rounded-full" src="/images/headerImages/pngegg-1.png"/>
        <img className="h-12 w-12 mr-6 p-2 hover:bg-gray-600 hover:rounded-full" src="/images/headerImages/pngegg.png"/>
